...
export function HackathonCard(link: hackathonLink) {
  ...
  return (
    <div className="rounded-lg border my-4 bg-gradient-to-r from-blue-300 to-violet-400 p-2 hover:shadow-2xl cursor-pointer hover:-translate-y-1 transi shadow-xl">
